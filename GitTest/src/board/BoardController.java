...
import board.BoardFormChangeAction;
...
public class BoardController extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {    
        loadProperties("board/properties/BoardCommand");
    }
	...
	private void loadProperties(String filePath) 
    {
        ...
        while (actionEnum.hasMoreElements()) 
        {
            ...
            try {
                 ...
                 if(className.equals("board.BoardFormChangeAction")){
                     BoardFormChangeAction mf = (BoardFormChangeAction)actionInstance;
